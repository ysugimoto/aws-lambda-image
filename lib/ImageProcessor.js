...
class ImageProcessor {
    ...
    processImage(imageData, config) {
        ...
        if ( config.exists("backup") ) {
            ...
            backup.keepOriginalExtension = backup.keepOriginalExtension || config.get("keepOriginalExtension") || false;
        ...
        if ( config.exists("reduce") ) {
            ...
            reduce.keepOriginalExtension = reduce.keepOriginalExtension || config.get("keepOriginalExtension") || false;
        ...
        config.get("resizes", []).filter((resize) => {
            ...
            resize.keepOriginalExtension = resize.keepOriginalExtension || config.get("keepOriginalExtension") || false;
